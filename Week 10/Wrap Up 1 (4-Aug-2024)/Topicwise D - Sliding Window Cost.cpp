...
void solve() {
    ...
    ll ans1 = abs(1LL * sza(lset) * *lset.rbegin() - lsum) + abs(rsum - 1LL * sza(rset) * *lset.rbegin());
    ll ans2 = abs(1LL * sza(lset) * *rset.begin() - lsum) + abs(rsum - 1LL * sza(rset) * *rset.begin());
    cout << min(ans1, ans2) << ' ';
    for (int i = 0, j = k; j < n; i++, j++) {
        ...
        if (sza(rset) > sza(lset)) {
            auto it = rset.begin();
            lsum += *it;
            rsum -= *it;
            lset.insert(*it);
            rset.extract(*it);
        } else if (sza(lset) - sza(rset) > 1) {
            auto it = lset.rbegin();
            rsum += *it;
            lsum -= *it;
            rset.insert(*it);
        ...
        ans1 = abs(1LL * sza(lset) * *lset.rbegin() - lsum) + abs(rsum - 1LL * sza(rset) * *lset.rbegin());
        ans2 = abs(1LL * sza(lset) * *rset.begin() - lsum) + abs(rsum - 1LL * sza(rset) * *rset.begin());
        cout << min(ans1, ans2) << ' ';
    }
}
