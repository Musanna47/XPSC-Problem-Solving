...
void solve() {
    ...
    // A + B + C
    if (v1.second != b[0].second) {
        v2 = b[0];
    } else {
        v2 = b[1];
    }
    if (v1.second != c[0].second && v2.second != c[0].second) {
        v3 = c[0];
    } else if (v1.second != c[1].second && v2.second != c[1].second) {
        v3 = c[1];
    } else {
        v3 = c[2];
    }
    ans = max(ans, v1.first + v2.first + v3.first);

    // A + C + B
    if (v1.second != c[0].second) {
        v2 = c[0];
    } else {
        v2 = c[1];
    }
    if (v1.second != b[0].second && v2.second != b[0].second) {
        v3 = b[0];
    } else if (v1.second != b[1].second && v2.second != b[1].second) {
        v3 = b[1];
    } else {
        v3 = b[2];
    }
    ...
    if (v1.second != a[0].second && v2.second != a[0].second) {
        v3 = a[0];
    } else if (v1.second != a[1].second && v2.second != a[1].second) {
        v3 = a[1];
    } else {
        v3 = a[2];
    }
